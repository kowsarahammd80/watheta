        ...
        <div className="">
          <div>
            ...
            <p className="whatsAppChatBotsTextPera pt-4">
              With our CRM, you can empower your team to optimize their
              productivity, improve sales, and reduce administrative tasks. It's
              time to redefine your business processes.
            </p>
            <div className="grid grid-cols-2 gap-4 pt-4">
              <div>
                <p className="persentTextNumber">35%</p>

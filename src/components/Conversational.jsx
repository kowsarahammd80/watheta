    ...
    <div className="conversationalbg p-5 lg:p-16 xl:p-16 md:p-8">
      <section className="mx-0 lg:mx-32 xl:ms-32 md:mx-5">
        ...
        <div className="pt-10 flex justify-center">
          <button className="flex items-center border rounded-full text-sm lg:text-lg xl:text-lg px-5 lg:px-8 xl:px-8 py-3 lg:py-3 xl:py-3 bg-white viewallindustryButtonText">
            View all industry
            <span className="ms-2">

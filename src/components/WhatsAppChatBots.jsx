...
const WhatsAppChatBots = () => {
  ...
  return (
    <div className="whatsAppChatBotsBg py-12 lg:py-20 xl:py-20 md:py-16">
      {/*  */}
      <section
        className={`flex flex-col-reverse lg:flex-row xl:flex-row md:flex-col-reverse items-start lg:items-center xl:items-center mx-5 lg:mx-48 xl:mx-48 lg:gap-20 xl:gap-20 gap-x-10`}
      >
        {/* ing contents */}

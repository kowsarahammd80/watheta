...
const WhatsAppChatBots = () => {
  return (
    <div className="whatsAppChatBotsBg py-20">
      ...
      <section className="flex flex-col-reverse lg:flex-row xl:flex-row md:flex-row items-start lg:items-center xl:items-center mx-5 lg:mx-48 xl:mx-48 lg:gap-20 xl:gap-20 gap-x-10">
        {/* ing contents */}
        ...
        {/* text contents */}
        <div className="justify-start lg:justify-end xl:justify-end">
